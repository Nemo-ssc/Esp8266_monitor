...
//---------------wifi连接/API用户名密码信息----------------
const char *ssid = "Honor V10";          //WiFi名
const char *password = "12345678";  //WiFi密码

String biliuid = "12772522";         //bilibili UID

const char* HOST = "http://api.seniverse.com";
const char* APIKEY = "SuQDmnIsehmcwH7cx";        //API KEY
const char* CITY = "taizhou";
...
void setup()
{
    ...
    u8g2.begin();
    u8g2.clearBuffer();
    u8g2.drawXBMP( 0 , 0 , 128 , 32 , bilibilitv_12832 );
    u8g2.sendBuffer();
    Serial.begin(115200);
    while (!Serial)
        continue;
...
bool parseJson_bff(String json)
{
...
void displayNumber_f(int number) 
{
...
bool parseJson_bfv(String json)
{
...
void displayNumber_v(int vw,int lk)
{
...
bool parseJson_ws(String json)
{
    ...
    day0.date_m = date0.substring(5, 7);
    day0.date_d = date0.substring(8, 10);
    day0.code_day = atoi(results_0_daily_0_code_day);//获取今天天气信息
    day0.high = atoi(results_0_daily_0_high);
    day0.low = atoi(results_0_daily_0_low);
    day0.wind_direction_degree = atoi(results_0_daily_0_wind_direction_degree);
    day0.wind_scale = atoi(results_0_daily_0_wind_scale);
    day0.humidity = atoi(results_0_daily_0_humidity);
